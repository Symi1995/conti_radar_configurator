...
const double FILTERCFG_MAX_NOFOBJ = 100; //8-volt
...
const double FILTERCFG_MAX_DISTANCE = 10;  // 409.5-volt
const double FILTERCFG_RES_DISTANCE = 0.1;
// Index 2. Clusters and objects
const int FILTERCFG_ACTIVE_AZIMUTH = 0;  // 0
const double FILTERCFG_MIN_AZIMUTH = -50; // (-50) Azimuth angle -50 - 52.375 deg
const double FILTERCFG_MAX_AZIMUTH = 50;    // (50)
const double FILTERCFG_MINIMUM_AZIMUTH = -50;
const double FILTERCFG_RES_AZIMUTH = 0.025;
// Index 3. Clusters and objects
const int FILTERCFG_ACTIVE_VRELONCOME = 0; // 0
...
const int FILTERCFG_ACTIVE_VRELDEPART = 0; // 0
...
// Index 6. Objects
const int FILTERCFG_ACTIVE_LIFETIME = 0; // 0
...
// Index 7. Objects
const int FILTERCFG_ACTIVE_SIZE = 0; // 0
...
// Index 8. Objectss
const int FILTERCFG_ACTIVE_PROBEXISTS = 0; // 0
const double FILTERCFG_MIN_PROBEXISTS = 4; // 5 Probability of existence
...
const double FILTERCFG_MIN_Y = -0.5; // Lateral distance -409.5 - 409.5 m
const double FILTERCFG_MAX_Y = 0.5; //TODO: teszthez 2, 3, 4, 5 látótávolságok -+ 
...
const double FILTERCFG_MAX_X = 5; //TODO: teszthez fixre beállítani (20, 25, 30 méterre kb)
...
// Index 15. Objects
const int FILTERCFG_ACTIVE_OBJECT_CLASS = 0;
const double FILTERCFG_MIN_OBJECT_CLASS = 0; // Longitudinal velocity component for departing moving ob
const double FILTERCFG_MAX_OBJECT_CLASS = 7; // 0 - 7 0x0: point, 0x1: car, 0x2: truck, 0x3: not used, 0x4: motorcycle, 0x5: bicycle, 0x6: wide, 0x7: reserved
const double FILTERCFG_RES_OBJECT_CLASS = 1;
...
const double COLLDETCFG_MINTIME = 1; // (0) Minimum time an object needs to be detected inside the region 0 - 25.5 s
...
const double COLLDETREGCFG_POINT2X = 4; // (1) Longitudinal position of second point -500 - 1138.2 m
